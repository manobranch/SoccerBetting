...
$.extend($.validator, {
	...
	methods: {
		...
		equalTo: function(value, element, param) {
			...
			// TaODO find a way to bind the event just once, avoiding the unbind-rebind overhead
...
;(function($) {
	...
	// TaODO verify if jQuery 1.4's implementation is compatible with older jQuery special-event APIs
